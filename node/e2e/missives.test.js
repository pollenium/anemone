...
var clients_test_1 = require("./clients.test");
...
var clients;
var missives = [];
test('fetch clients', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, clients_test_1.fetchClients()];
            case 1:
                clients = _a.sent();
                return [2 /*return*/];
        }
            ...
            client.missiveSnowdrop.addHandle(function (_missive) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            receivesCount++;
                            if (!(receivesCount === params_1.missivesReceivesCount)) return [3 /*break*/, 2];
                            return [4 /*yield*/, delay_1["default"](2000)];
                        case 1:
                            _a.sent();
                            if (receivesCount !== params_1.missivesReceivesCount) {
