...
var Wisteria = /** @class */ (function () {
    function Wisteria(url) {
        var _this = this;
        this.openPrimrose = new pollenium_primrose_1.Primrose();
        ...
        this.websocket.onopen = function () {
            _this.openPrimrose.resolve();
        };
        this.websocket.onerror = function (event) {
            _this.openPrimrose.reject(event);
        };
        this.websocket.onclose = function () {
            _this.closePrimrose.resolve();
        };
        this.websocket.onmessage = function (message) {
            _this.dataSnowdrop.emit(pollenium_uvaursi_1.Uu.wrap(message.data));
        };
    }
    Wisteria.prototype.awaitOpen = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.openPrimrose.promise];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Wisteria.prototype.awaitClose = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.closePrimrose.promise];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Wisteria.prototype.send = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.awaitOpen()];
                    case 1:
                        _a.sent();
