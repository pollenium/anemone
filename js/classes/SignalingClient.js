...
var SignalingClient = (function (_super) {
    ...
    function SignalingClient(signalingServerUrl) {
        var _this = _super.call(this) || this;
        _this.signalingServerUrl = signalingServerUrl;
        _this.bootstrapPromise = _this.bootstrap();
        return _this;
    }
    SignalingClient.prototype.bootstrap = function () {
    ...
    SignalingClient.prototype.fetchConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            var wsConnectionPromise;
            var _this = this;
            return __generator(this, function (_a) {
                if (this.wsConnectionPromise) {
                    return [2, this.wsConnectionPromise];
                }
                wsConnectionPromise = new Promise(function (resolve, reject) {
                    _this.wsClient.once('connectFailed', function (error) {
                        reject(error);
                    });
                    _this.wsClient.once('connect', function (wsConnection) {
                        resolve(wsConnection);
                    });
                });
                this.wsClient.once('close', function () {
                    delete _this.wsConnectionPromise;
                    _this.wsConnectionPromise = _this.fetchConnection();
                });
                this.wsClient.connect(this.signalingServerUrl);
                return [2, wsConnectionPromise];
            });
        });
    };
