...
var Extrovert = (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.offerSdpPromise = new Promise(function (resolve) {
                    _this.simplePeer.once('signal', function (offer) {
                        resolve(offer.sdp);
                        setTimeout(function () {
    ...
    Extrovert.prototype.fetchStatusPojo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var offer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        offer = _a.sent();
                        return [2, Object.assign(_super.prototype.getStatusPojo.call(this), {
                                offerSentAgo: (utils_1.getNow() - this.offersSentAt),
    ...
    Extrovert.prototype.destroy = function () {
        var friendIndex = this.client.extroverts.indexOf(this);
