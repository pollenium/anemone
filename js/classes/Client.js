...
var Client = (function (_super) {
    ...
    Client.prototype.loopCreateFriend = function (timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Client.prototype.createFriend = function () {
        ...
        var offer = this.popConnectableOffer();
        if (offer === null) {
    ...
    Client.prototype.addSignalingClient = function (signalingServerUrl) {
        var _this = this;
        var signalingClient = new SignalingClient_1.SignalingClient(signalingServerUrl);
    ...
    Client.prototype.fetchStatusPojo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var offersCountByClientNonceHex, offerIdHexByClientNonceHex, isConnectableByClientNonceHex, _a;
            var _this = this;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        this.offers.forEach(function (offer) {
                            var clientNonceHex = offer.clientNonce.getHex();
                            if (offersCountByClientNonceHex[clientNonceHex] === undefined) {
                                ...
                                isConnectableByClientNonceHex[clientNonceHex] = _this.getIsConnectableByClientNonce(offer.clientNonce);
                            }
                            else {
                                offersCountByClientNonceHex[clientNonceHex] += 1;
                            }
                        });
                        Object.keys(this.offersReceivedByClientNonceHex).forEach(function (clientNonceHex) {
                            isConnectableByClientNonceHex[clientNonceHex] = _this.getIsConnectableByClientNonce(Bytes_1.Bytes.fromHex(clientNonceHex));
                        });
                        _a = {
                        ...
                        return [4, Promise.all(this.extroverts.map(function (extrovert) {
                                return extrovert.fetchStatusPojo();
                            }))];
                    case 1: return [2, (_a.extroverts = _b.sent(),
                            _a.introverts = this.introverts.map(function (introvert) {
